            ...
            <table id="sqltable">
                ...
                <c:forEach var="list" items="${thinglist}">
                    <tr class="rows">
                        ...
                        <td>${list.singer.name}</td>
                        <td>
                            <a href="${pageContext.request.contextPath}/admin/Thing_addPage.action?thing.id=${list.id}">更新</a>
    ...
    $(function () {
        $(".del").click(function () {
            ...
            layer.confirm('您确认要删除这条数据吗？', {
                ...
                $.post("${pageContext.request.contextPath}/admin/Thing_del.action", {'thing.id': id}, function (result) {
