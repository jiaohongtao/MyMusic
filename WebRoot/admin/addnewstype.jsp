    ...
    <tr>
        ...
        <td>
            ...
            <form class="layui-form" id="sqlform" method="post"
                  action="${pageContext.request.contextPath}/admin/NewsType_addForm.action?newstype.id=${newstype.id}">
                <table cellpadding="0" cellspacing="0" id="addtable">
                    <tr>
                        <td class="left">类型名称：</td>
                        <td class="right"><label>
                            <input type="text" lay-verify="required" name="newstype.type"
                                   class="layui-input" value="${newstype.type}"/>
                        </label></td>
                    </tr>
                    <tr>
                        <td class="left">&nbsp;</td>
